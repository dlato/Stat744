...
So, I wanted an transparent value that would still allow for sections of the graph to be densely coloured with these overlapping genes, but still for the most part have all points visible.
