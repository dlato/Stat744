...
vio_bar<-ggplot(all_data, aes(x=class, y=log10(value), fill=class)) +
  geom_violin() +
...
#make the omega a math symbol in both the legend and x-axis
        scale_fill_manual(values=c("#969696", "#D9D9D9", "#525252"), labels = c(" dN", " dS", expression(omega)))  +
...
Legend might be repetitive so we can remove it.
```{r g1 no legend}
vio_bar + 
