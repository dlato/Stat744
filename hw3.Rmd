...
#reodering levels by median omega
...
The median dots (dark blue) also help illustrate the above mentions trends: dS > dN, and $\omega$ < 1 for majority of the genes.
...
One advantage of the strip plot in this case is that because it shows the actual points, you can tell where the violin plot may have been misleasing.
