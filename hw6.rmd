...
JD: Thoughtful and attractive. There should be a way to do direct labels and have better control over where they go. In this case, it seems like there should be good places for them without extending the axes (although I wouldn't know how to do it, we could ask BB if you're interested).
